  ...
  return (
    <div className="max-w-3xl mx-auto text-center space-y-8 p-10 animate-float">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-12">
        ...
        >
          <h3 className="text-lg font-bold text-aether mb-2">{t.btn_phare}</h3>
          <p className="text-sm text-gray-500">{t.desc_phare}</p>
        </button>
        ...
        >
          <h3 className="text-lg font-bold text-mystic mb-2">{t.btn_jardin}</h3>
          <p className="text-sm text-gray-500">{t.desc_jardin}</p>
        </button>
        ...
        >
          <h3 className="text-lg font-bold text-starlight mb-2">{t.btn_chat}</h3>
          <p className="text-sm text-gray-500">{t.desc_chat}</p>
        </button>
      </div>
    </div>
  );
...
const App: React.FC = () => {
  ...
  const renderView = () => {
    switch (currentView) {
      ...
      case ViewState.HOME:
      default:
        return <HomeView setView={setCurrentView} lang={lang} />;
    }
  };
